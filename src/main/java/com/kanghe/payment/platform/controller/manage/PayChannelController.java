...
import com.kanghe.payment.platform.service.PayChannelService;
...
public class PayChannelController {
    ...
    public String list(@ModelAttribute PayChannel payChannel, Integer pageIndex, Integer pageSize) {
        ...
        int count = payChannelService.getCount(payChannel);
        if (count <= 0) {
            return JSON.toJSONString(pageModel);
        }
        List<PayChannel> payChannelList = payChannelService.getList((pageIndex - 1) * pageSize, pageSize, payChannel);
